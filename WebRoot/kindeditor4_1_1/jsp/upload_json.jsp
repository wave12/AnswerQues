...
String savePath = request.getSession().getServletContext().getRealPath("/") + "upfiles/";
...
String strUserIDFolder = session.getAttribute("admin").toString();
strUserIDFolder = strUserIDFolder.substring(0, strUserIDFolder.indexOf('|'));
...
//创建文件夹 
savePath += strUserIDFolder + "/" + dirName + "/";//D:\Tomcat6.0\webapps\zswz\attached/image/ 
saveUrl += strUserIDFolder + "/" + dirName + "/";///zswz/attached/image/ 
