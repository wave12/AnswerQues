...
<html>
  ...
  function ChangeCate(cateID, obj, pageNo) {
    ...
    if (newCate == "c1")
        ...
        window.location.href = "<%=path%>/askpro/join_question";
        return;
    }
    else
  ...
  <body style="width:100%; padding:0px; margin:0px">
    <div class="MainHeadRow">
       ...
       <div class="HeadToolBtnArea">
       		<input id="curActiveCate" style="display:none" value="0" />
       		<div onclick="ChangeCate(1, 'c1', 1)" id="c1" class="FirstBtnActive">我的问题</div>
       		<div onclick="ChangeCate(2, 'c2', 1)" id="c2"  class="LastBtnActiveNo">参与的问题</div> 
       </div>
    </div>
       ...
       <table cellspacing="0" cellpadding="0" border="0" width="100%" class="TblRecord">
	     ...
	     <s:iterator id="obj" value="#request.questionList"  status="L">			   
				  ...
				  <td  class="DocDt"><s:date name="#obj.dt" format="yy-MM-dd HH:mm"/></td>		     
				     <td class="RecordActionCol"><a target="_blank" href="<%=path%>/askpro/close?id=${obj.id}"><span class="BtnPayHandle">结算</span></a> 
				     </td>
				  </tr>
		  </s:iterator>
	  </table>	 
